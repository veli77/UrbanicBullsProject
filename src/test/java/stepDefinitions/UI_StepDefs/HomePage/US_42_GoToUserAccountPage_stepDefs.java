...
public class US_42_GoToUserAccountPage_stepDefs {
    ...
    public void theUserShouldSeeLeftsideTabs(DataTable dataTable) {
        ...
        for (int i = 0; i <commonPage.getAccountPage().accountPageLeftsidesTabs.size(); i++) {

            tabs.add(commonPage.getAccountPage().accountPageLeftsidesTabs.get(i).getText());
        }
